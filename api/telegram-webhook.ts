 ...
 * При /start или нажатии кнопки «Старт» — только сообщение про Каталог и кнопка «Старт».
 * Приветствие задаётся в BotFather (About/Description) и показывается при входе в бота.
 */
